...
public class PedidoProductoTest {
        ...
        void grabarPorPropietarioDeManyToMany() {
                ...
                Pedido pedido1 = new Pedido(0, "Programación", new HashSet<Contacto>(), cliente1);
                pedidoRepository.save(pedido1);


                Pedido pedido2 = new Pedido(0, "Base de datos", new HashSet<Contacto>(), cliente2);
                pedidoRepository.save(pedido2);

                Contacto producto1 = new Contacto(0, "Producto1 - Programando fácil con JPA :P", new HashSet<>());
                ...
                Contacto producto2 = new Contacto(0, "Producto2 - Programando fácil2 con JPA :P", new HashSet<>());
                ...
                void grabarPedidoQueYaExiste() {
                        ...
                        Contacto producto2 = new Contacto(0, "Producto2 - NO programando tan fácilmente...", new HashSet<>());
...
/* List<Pedido> pedidos = entityManager.createQuery(
                      ...
                      //y cargar en la colección. NOTA: si utilizas EAGER puedes prescindir de join fetch.
                       */
/* List<Contacto> productos = entityManager.createQuery(
                                "select p " +
                                        "from Contacto p " +
                                        "join fetch p.pedidos ts " +
                                        "where ts.id = :id", Contacto.class)
...
/*List<Contacto> productos = entityManager.createQuery(
                        ...
                        *//*
                        ...
                        ArrayList<Contacto> auxCopyProductos = new ArrayList<>(pedido3.getProductos());
